    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between flex-wrap">
          ...
          <div class="btn-group">
            <a href="<?= base_url('pakai_ban/detailAll') ?>" class="btn btn-sm btn-success mb-2">
              <i class="far fa-file-alt fa-sm"></i>
              Detail All
            </a>
            <a href="<?= base_url('pakai_ban/addData') ?>" class="btn btn-sm btn-dark mb-2">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="pakaiBanTables" width="100%" cellspacing="0">
