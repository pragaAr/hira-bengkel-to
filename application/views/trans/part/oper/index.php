    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between flex-wrap">
          ...
          <div class="btn-group">
            <a href="<?= base_url('oper/allDataPakai') ?>" class="btn btn-sm btn-dark mb-2">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="operTables" width="100%" cellspacing="0">
...
<!-- Modal Oper -->
<div class="modal fade" id="operanModal" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-3">
      <div class="modal-header">
        <h5 class="modal-title text-dark">Form Oper Part Lagi</h5>
