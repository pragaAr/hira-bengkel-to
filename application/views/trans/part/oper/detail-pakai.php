      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="allPakaiTables" width="100%" cellspacing="0">
...
<!-- Modal Oper -->
<div class="modal fade" id="operModal" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-3">
      <div class="modal-header">
        <h5 class="modal-title text-dark">Form Oper Part</h5>
      ...
      <div class="modal-body">
        ...
        <hr>
        <form action="<?= base_url('oper/operPart') ?>" method="post">
          <div class="form-row">
            <div class="form-group col-lg-6 col-md-6">
              <label class="font-weight-bold" for="part">Jenis</label>
              ...
              <input type="hidden" class="form-control" id="totpakai" name="totpakai" readonly>
